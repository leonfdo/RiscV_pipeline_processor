...
HD_PWD='C:/Users/leonf/OneDrive/Documents/pipeline_forward/pipeline/pipeline.runs/design_1_Pipeline_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Pipeline_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Pipeline_wrapper_0_0.tcl
